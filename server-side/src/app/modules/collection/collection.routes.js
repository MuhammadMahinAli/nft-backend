...
import {createCollection, deleteCollection, getAllCollection, getCollectionsBySeller, getSingleCollection, updateCollection} from "./collection.controller.js";
...
router.get("/getAll/:id", getCollectionsBySeller);
